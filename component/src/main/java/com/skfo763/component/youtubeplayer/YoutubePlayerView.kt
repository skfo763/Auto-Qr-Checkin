package com.skfo763.component.youtubeplayer
...
class YouTubePlayerView @JvmOverloads constructor(
    ...
    init {
        LayoutInflater.from(context).inflate(R.layout.layout_youtube_player_fragment, this, true)
        attrs?.let {
            val typedArray = context.obtainStyledAttributes(attrs, R.styleable.YouTubePlayerView, defStyle, 0)
